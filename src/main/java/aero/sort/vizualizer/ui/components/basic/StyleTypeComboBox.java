...
public class StyleTypeComboBox extends JComboBox<StyleType> {
    ...
    private static final Map<StyleType, Set<Style>> styleTypeToStyle = //
            Map.of( //
                    StyleType.PLAIN,
                    Set.of(Style.CUSTOM_PLAIN, Style.CYAN, Style.GREEN, Style.PURPLE, Style.WHITE, Style.YELLOW), //
                    StyleType.SPECIAL, Set.of(Style.RAINBOW, Style.RELATIVE_TO_POSITION), //
                    StyleType.GRADIENT,
                    Set.of(Style.CUSTOM_GRADIENT, Style.APP, Style.AQUA, Style.GRAY, Style.SUNRISE, Style.SUNSET));
